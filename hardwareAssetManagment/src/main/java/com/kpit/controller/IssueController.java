...
// }
 ...
 @PutMapping("/issued/{UserId}/{HardwareId}")
 public ResponseEntity<Boolean> returnIssuedHardware(@PathVariable  Long UserId, @PathVariable  Long HardwareId) {
     boolean result = issueService.returnIssuedHardware(UserId , HardwareId);
